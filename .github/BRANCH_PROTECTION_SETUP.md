...
1. Go to your GitHub repository: `https://github.com/Crashcart/MusicBot`
...
- [ ] `Build` (from build.yml — TypeScript compilation + Docker build)
...
- Add: `@Crashcart/musicbot-maintainers` (or your team)
...
gh api repos/Crashcart/MusicBot/branches/main/protection \
  -X PUT \
  -F required_status_checks='{"strict": true, "contexts": ["Build", "Lint & Format", "Tests"]}' \
  -F required_pull_request_reviews='{"required_approving_review_count": 1}' \
  -F enforce_admins=true \
  -F allow_auto_merge=true

# Add branch protection for test
gh api repos/Crashcart/MusicBot/branches/test/protection \
  -X PUT \
  -F required_status_checks='{"strict": true, "contexts": ["Build", "Lint & Format", "Tests"]}' \
  -F required_pull_request_reviews='{"required_approving_review_count": 1}' \
  -F allow_auto_merge=true
